# #coding:utf8
from RetailProj.util import time_util,str_util
...
class OrdersModel:
    ...
    def check_and_transfer_area(self):
...
class OrdersDetailModel:
    ...
    def generate_intsert_sql(self):
        sql=f'insert into {conf.target_order_details_table_name} (" \
    ...
    def to_csv(self,sep=','):
        csv_lines=''
        for model in self.products_details:
            csv_lines+=model.to_csv()
            csv_lines+='\n'
        return csv_lines
class SingleProductSoldModel:
    def __init__(self, order_id, product_detail_dict):
        self.order_id = order_id
        self.count = product_detail_dict['count']
        # index = int(product_detail_dict['count'])  # Use the desired index from the list
        # self.count = product_detail_dict[index]['count']
        self.name = product_detail_dict['name']
        self.unit_id = product_detail_dict["unitID"]
        self.barcode = product_detail_dict["barcode"]
        self.price_per = product_detail_dict["pricePer"]
        self.retail_price = product_detail_dict["retailPrice"]
        self.trade_price = product_detail_dict["tradePrice"]
